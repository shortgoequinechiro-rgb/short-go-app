    ...
    async function load() {
      ...
      if (ownerErr || !ownerData) {
        ...
        try {
          ...
          if (cached) {
            setOwner({ id: cached.id, full_name: cached.full_name, phone: cached.phone, email: cached.email, address: cached.address, vet_name: null, vet_practice_name: null, vet_phone: null, vet_email: null, vet_license_number: null })
          } else {
            setNotFound(true)
            setLoading(false)
            return
